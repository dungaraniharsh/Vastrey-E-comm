...
class Analytics
{
    ...
    protected function _setDataOject() {
        ...
        foreach ($this->_socialMedia as $type => $label) {
            ...
            $this->_reportModel->setReportData($this->_type, $this->_serializer->serialize($dataObject));
        }
    ...
    protected function _setTotalDataObject() {
        ...
        $this->_reportModel->setReportData('total',  $this->_serializer->serialize($totalDataObject));
