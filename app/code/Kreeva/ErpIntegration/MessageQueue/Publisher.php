 ...
 */
namespace Kreeva\ErpIntegration\MessageQueue;
 ...
 */
class Publisher extends \Magento\Framework\MessageQueue\Publisher
{
    /**
    ...
    public function __construct(
        ...
        parent::__construct($exchangeRepository,
                            $envelopeFactory,
                            $messageQueueConfig,
                            $messageEncoder,
                            $messageValidator);
    ...
    public function publish($topicName, $data)
    {
        ...
        $messageId = md5(uniqid($topicName));
        ...
        return ['message_id' => $messageId, 'data' => $data];
    }
